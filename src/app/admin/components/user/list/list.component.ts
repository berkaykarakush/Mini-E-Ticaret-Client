...
import { AuthorizeUserDialogComponent } from 'app/dialogs/authorize-user-dialog/authorize-user-dialog.component';
...
export class ListComponent extends BaseComponent implements OnInit {
  ...
  async getUsers(){
    ...
    const allUsers: { totalUsersCount: number; users: List_User[] } = await this.userService.getAllUsers(this.paginator ? this.paginator.pageIndex : 0, this.paginator ? this.paginator.pageSize : 5, () => this.hideSpinner(SpinnerType.Ball8bits), (errorMessage: any) => {
